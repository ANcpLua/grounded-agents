...
├── docs/                          Design document (Markdown source, PDF, diagram sources)
...
formatting, and the design document follows pandoc conventions; all are excluded:

```bash
npx markdownlint-cli2 "**/*.md" "#Hosted-FoundryIQ" "#Hosted-FoundryMcpTools" "#GOAL.md" "#docs"
```
